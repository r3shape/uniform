...
u8 r3_init_pack(void* r3_core) {
    ...
    if (r3_pack != NULL) return LIBX_TRUE;  // redundant call: pack api initialized!

    core_pack = r3_core;
    r3_pack = (_r3_pack_api*)libx->memx.alloc(sizeof(_r3_pack_api), 8);
...
u8 r3_cleanup_pack(void) {
    if (!r3_pack || !core_pack) return LIBX_TRUE;    // reduntant call: pack api not initialized!
