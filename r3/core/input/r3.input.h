...
typedef struct _r3_input_api {
    ...
    u8 (*key_was_up)(R3_Keyboard_Key key);
    u8 (*key_is_down)(R3_Keyboard_Key key);
    u8 (*key_was_down)(R3_Keyboard_Key key);

    u8 (*button_is_up)(R3_Mouse_Button button);
    u8 (*button_was_up)(R3_Mouse_Button button);
    u8 (*button_is_down)(R3_Mouse_Button button);
    u8 (*button_was_down)(R3_Mouse_Button button);
