...
LOTUS_API char* ltGetMemoryUsageStr(void);
LOTUS_API void ltMemZero(void* block, u64 size);
LOTUS_API void* ltMemAlloc(u64 size, LTmemoryTag tag);
LOTUS_API void* ltMemSet(void* block, i32 value, u64 size);
LOTUS_API void ltMemFree(void* block, u64 size, LTmemoryTag tag);
LOTUS_API void* ltMemCopy(void* dest, const void* source, u64 size);
