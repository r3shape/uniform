...
typedef enum tagkeyboardKeys {
    ...
    LOTUS_DEFINE_KEY(NUMPAD0, 0x60),
    LOTUS_DEFINE_KEY(NUMPAD1, 0x61),
    LOTUS_DEFINE_KEY(NUMPAD2, 0x62),
    LOTUS_DEFINE_KEY(NUMPAD3, 0x63),
    LOTUS_DEFINE_KEY(NUMPAD4, 0x64),
    LOTUS_DEFINE_KEY(NUMPAD5, 0x65),
    LOTUS_DEFINE_KEY(NUMPAD6, 0x66),
    LOTUS_DEFINE_KEY(NUMPAD7, 0x67),
    LOTUS_DEFINE_KEY(NUMPAD8, 0x68),
    LOTUS_DEFINE_KEY(NUMPAD9, 0x69),
...
LOTUS_API_ENTRY b8 ltIsKeyDown(LTkeyboardKey key);
LOTUS_API_ENTRY b8 ltWasKeyDown(LTkeyboardKey key);

LOTUS_API_ENTRY b8 ltIsButtonUp(LTmouseButton button);
LOTUS_API_ENTRY b8 ltWasButtonUp(LTmouseButton button);
LOTUS_API_ENTRY b8 ltIsButtonDown(LTmouseButton button);
LOTUS_API_ENTRY b8 ltWasButtonDown(LTmouseButton button);

LOTUS_API_ENTRY void ltGetMousePosition(i32* x, i32* y);
LOTUS_API_ENTRY void ltGetPreviousMousePosition(i32* x, i32* y);
