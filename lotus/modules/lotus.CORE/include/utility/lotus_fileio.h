 ...
 */
LOTUS_API_ENTRY ubyte lotus_is_file(const char* path);
 ...
 */
LOTUS_API_ENTRY char* lotus_read_file(const char* path);
 ...
 */
LOTUS_API_ENTRY ubyte lotus_delete_file(const char* path);
 ...
 */
LOTUS_API_ENTRY long lotus_get_file_size(const char* path);
 ...
 * @return 1 on success, 0 on failure.
 */
LOTUS_API_ENTRY ubyte lotus_copy_file(const char* dest, const char* src);
 ...
 * @return 1 on success, 0 on failure.
 */
LOTUS_API_ENTRY ubyte lotus_append_file(const char* data, const char* path, ubyte newline);
 ...
 * @return 1 on success, 0 on failure.
 */
LOTUS_API_ENTRY ubyte lotus_write_file(const char* data, const char* path, ubyte preserve);
 ...
 * @return 1 on success, 0 on failure.
 */
LOTUS_API_ENTRY ubyte lotus_process_file(void (*processLine)(const char* line), const char* path);
