 ...
 */
R3_API ubyte r3_is_file(const char* path);
 ...
 */
R3_API char* r3_read_file(const char* path);
 ...
 */
R3_API ubyte r3_delete_file(const char* path);
 ...
 */
R3_API long r3_get_file_size(const char* path);
 ...
 * @return 1 on success, 0 on failure.
 */
R3_API ubyte r3_copy_file(const char* dest, const char* src);
 ...
 * @return 1 on success, 0 on failure.
 */
R3_API ubyte r3_append_file(const char* data, const char* path, ubyte newline);
 ...
 * @return 1 on success, 0 on failure.
 */
R3_API ubyte r3_write_file(const char* data, const char* path, ubyte preserve);
 ...
 * @return 1 on success, 0 on failure.
 */
R3_API ubyte r3_process_file(void (*processLine)(const char* line), const char* path);
